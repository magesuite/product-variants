...
$product->setTypeId(\Magento\Catalog\Model\Product\Type::TYPE_SIMPLE)
    ...
    ->setUrlKey('product-variant-3-disabled')
    ->setArticleGroupId('group_1')
    ->setPrice(10)
    ->setVisibility(\Magento\Catalog\Model\Product\Visibility::VISIBILITY_BOTH)
...
$product->setTypeId(\Magento\Catalog\Model\Product\Type::TYPE_SIMPLE)
    ...
    ->setUrlKey('product-without-variants')
...
$product->setTypeId(\Magento\Catalog\Model\Product\Type::TYPE_SIMPLE)
    ...
    ->setUrlKey('product-without-common-prefix')
...
$product->setTypeId(\Magento\Catalog\Model\Product\Type::TYPE_SIMPLE)
    ...
    ->setUrlKey('without-common-prefix-product')
    ->setArticleGroupId('group_3')
    ->setPrice(10)
    ->setVisibility(\Magento\Catalog\Model\Product\Visibility::VISIBILITY_BOTH)
    ->setStatus(\Magento\Catalog\Model\Product\Attribute\Source\Status::STATUS_ENABLED)
...
$product->setTypeId(\Magento\Catalog\Model\Product\Type::TYPE_SIMPLE)
    ...
    ->setUrlKey('product-without-common-suffix')
...
$product->setTypeId(\Magento\Catalog\Model\Product\Type::TYPE_SIMPLE)
    ...
    ->setUrlKey('without-common-suffix-product')
    ->setArticleGroupId('group_4')
    ->setPrice(10)
    ->setVisibility(\Magento\Catalog\Model\Product\Visibility::VISIBILITY_BOTH)
    ->setStatus(\Magento\Catalog\Model\Product\Attribute\Source\Status::STATUS_ENABLED)
...
$product->setTypeId(\Magento\Catalog\Model\Product\Type::TYPE_SIMPLE)
    ->setId(608)
    ->setAttributeSetId(4)
    ->setName('Without common suffix product out of stock')
    ->setSku('without_common_suffix_product_out_of_stock')
    ->setUrlKey('without-common-suffix-product-out-of-stock')
    ->setArticleGroupId('group_4')
    ->setPrice(10)
    ->setVisibility(\Magento\Catalog\Model\Product\Visibility::VISIBILITY_BOTH)
    ->setStatus(\Magento\Catalog\Model\Product\Attribute\Source\Status::STATUS_ENABLED)
